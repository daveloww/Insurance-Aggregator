...
############   Payment_Success queue    #############
queue_name = 'Payment_Success'
channel.queue_declare(queue=queue_name, durable=True)

channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='payment.success') 

# ############   Agent_Request queue    #############
# queue_name = 'Agent_Request'
# channel.queue_declare(queue=queue_name, durable=True)

# channel.queue_bind(exchange=exchangename, queue=queue_name, routing_key='agent.request') 
