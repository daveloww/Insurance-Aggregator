...
from policy_data import aviva_policies
...
@app.route("/aviva/category/<string:cat>")
def get_by_category(cat):
    try:
        ...
        return jsonify({
            "code": 500,
            "message": "aviva.py internal error: " + ex_str
        }), 500

# retrieve a policy, based on its policy_id
@app.route("/aviva/id/<string:policy_id>")
...
@app.route("/aviva/createpolicy/<string:policy_id>")
...
if __name__ == "__main__": 
    print("This is flask for " + os.path.basename(__file__) + ": retrieving Aviva policies...")
