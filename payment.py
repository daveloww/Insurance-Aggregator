...
paypalrestsdk.configure({
    "mode":"sandbox",
    "client_id" : "", # enter paypal sandbox client_id here
    "client_secret" : "" # enter paypal sandbox client_secret here
})
...
def payment():
    ...
    "redirect_urls": {
        "return_url": "http://localhost/Insurance_Aggregator/templates/receipt.html?"+return_url,
        "cancel_url": "http://localhost/Insurance_Aggregator/templates/policies.html"}, 
    "transactions": [{
        "item_list": {
            "items": [{
